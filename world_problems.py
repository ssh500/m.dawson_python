...
print("6 * 3 =", 6 * 3)
#
print("\nЕсли в ресторане вам с приятелями принесли счёт на 19 долларов (считая чаевые),")
print("и вы решили скинуться поровну на четверых, то сколько придётся с каждого?")
input("чтобы узнать, нажмите Enter")
print("19 / 4 =", 19 / 4)
#
print("\nЕсли четверо пиратов найдут сундук, в котором ровно 107 золотых монет, и ")
print("решат разделить добычу поровну, то сколько целых монет достанется каждому?")
input("Чтобы узнать, нажмите Enter")
print("107 // 4 =", 107 // 4)
#
print("\nЕсли теже самые четверо пиратов разделят те же 107 монет из сундука поровну,")
